...
//in this question our visited array will be made on the basis such that if the current state in which we are in has been obtained before and if yes we dont visit it else we 
